export default {
  "page.assets.balance.estimated_value": "Estimated Value",
  "page.assets.balance.hide_small": "Hide Small Balances",
  "page.assets.history.empty": "You dont have any transaction",
  ...
  "page.assets.deposit.fiat.note": `
    ...
    • Please make sure that your computer and browser are secure and your information is protected from being tampered or leaked.
  `,
  "page.assets.withdraw.new_address": "New Address",
  "page.assets.withdraw.address_book": "Address Book",
  "page.assets.withdraw.note": `
